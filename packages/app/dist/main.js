...
function runConnectedCallback(vm) {
  ...
  if (!shouldUseNativeCustomElementLifecycle(vm.component.constructor) && ("development" !== 'production' )) {
...
const $fragment1 = parseFragment`<h1${3}>Hello world! From Lightning Web Components \\o/</h1>`;
